...
exports.ContaImposto = exports.Banco = exports.Cliente = exports.Conta = void 0;
class Conta {
    _id;
    _numero;
    _saldo;
    ...
    renderJuros(numero) {
        ...
        if (contaProcurada) {
            if (contaProcurada instanceof Poupanca) {
                ...
                /*O cast é desnecessario apos o if, cortesia do TypeScript */
            }
            else {
                console.log('Poupança não encontrada!');
            }
        }
    }
    inserirConta(conta) {
...
let poupanca = new Poupanca("222", 100, 3);
