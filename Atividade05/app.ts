...
import { Conta, Cliente, Banco, ContaImposto } from "./banco";
...
do {
    ...
    console.log('09 - Transferir Titularidade  10 - Contas sem clientes  11 - Render Juros');
...
function inserirConta(): void {
    ...
    let tipo: string = input('Digite 1 - Conta ou 2 - Poupança: ');
    let conta:Conta;
    if (tipo = "2"){
...
function renderJuros(): void {
    console.log("\nRender Juros:");
    let numeroOrigem: string = input('Digite o número da poupança: ');
